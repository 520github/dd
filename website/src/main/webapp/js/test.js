$(function ()
{
    ...
    //  =============
        ...
        +	    				'<a class="loginLogo" id="evernote_login__logo__in" href="http://www.evernote.com/" target="_blank"></a>'
        +	    				'<a class="loginLogo" id="evernote_login__logo__cn" href="http://app.yinxiang.com/" target="_blank"></a>'
	...
	//	======
		...
		//	theme boxes		
		$('#settings__4__1').click(function () { __select_theme_from_menu('theme-1'); $('#settings__4__1').addClass('selected'); });
		$('#settings__4__2').click(function () { __select_theme_from_menu('theme-2'); $('#settings__4__2').addClass('selected'); });
		$('#settings__4__3').click(function () { __select_theme_from_menu('theme-3'); $('#settings__4__3').addClass('selected'); });	
		...
		//	size buttons
		$('#settings__4__fontSize__small').click(function ()  { __select_size_from_menu('small');  $('#settings__4__fontSize__small').addClass('selected'); });
		$('#settings__4__fontSize__medium').click(function () { __select_size_from_menu('medium'); $('#settings__4__fontSize__medium').addClass('selected'); });
		$('#settings__4__fontSize__large').click(function ()  { __select_size_from_menu('large');  $('#settings__4__fontSize__large').addClass('selected'); });
	...
	*/
	...
	var 
		...
		[
			...
			['to-extension--select-theme-1', 			    	'click-141-141-141-141-1-1-1'],
			['to-extension--select-theme-2', 				    'click-142-142-142-142-1-1-1'],
			['to-extension--select-theme-3', 		    		'click-143-143-143-143-1-1-1'],
			['to-extension--select-theme-custom', 	    		'click-144-144-144-144-1-1-1'],

			['to-extension--select-size-small',     			'click-151-151-151-151-1-1-1'],
			['to-extension--select-size-medium', 			    'click-152-152-152-152-1-1-1'],
			['to-extension--select-size-large', 		    	'click-153-153-153-153-1-1-1'],

			['to-extension--track--view', 			            'click-161-161-161-161-1-1-1'],
			['to-extension--track--clip', 		    	        'click-162-162-162-162-1-1-1'],
			['to-extension--track--theme-popup', 			    'click-163-163-163-163-1-1-1'],
			['to-extension--track--settings', 			        'click-164-164-164-164-1-1-1'],
